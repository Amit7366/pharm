...
@section('content')
    <div class="widget">
        <a class="heading bn">Add Generic</a>

        <form class="row g-3 needs-validation mt-1" action="{{route('InsertGeneric')}}" method="post" novalidate>
            @csrf
            <div class="col-md-6">
                <label for="validationCustom03" class="form-label">Name Of Generic</label>
                <input type="text" class="form-control" id="validationCustom03" name="generic" required>
                <div class="invalid-feedback">
                    Please input Generic name.
                </div>
