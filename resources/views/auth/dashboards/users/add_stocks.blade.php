                ...
                <div class="sub-content-widget">
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <select class="js-example-basic-single" name="state" id="med_list" required>
                        ...
                        <div class="col-md-2" id="dfdf">
                            <label for="validationCustom03" class="form-label">Rate (Per Piece)</label>
                            <input type="text" class="form-control" id="rate" autocomplete="off"  required>
                        </div>
                        <div class="col-md-2">
                            <button class="btn btn-primary addbtn" type="submit" id="addbutton" style="visibility: hidden">Add To Stock</button>
                        </div>
                    </div>
                </div>
                <div class="sub-content-widget">
                            ...
                            <table class="table">
                                ...
                                @forelse($cart as $product)
                                    <tr class="items">
                                        ...
                                        <td class="ex_date">{{$product->options->size}}</td>
                                        <input type="hidden" class="med_id" value="{{$product->id}}">
                                        <td class="qty">{{$product->qty}}</td>
                                        <td class="price">{{$product->price}}</td>
                                        <td class="subtotal">{{$product->subtotal}}</td>
                                        <td><a href="newstockdelete/{{$product->rowId}}" id="delete"><span class="trash-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
...
<path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-success text-center" style="font-size: 20px">No Stocks Add!</td>
                                        </tr>
                                @endforelse
                                </tbody>
                            </table>
                ...
                <div class="sub-content-widget">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="invoice_number" autocomplete="off">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <label for="validationCustom03" class="form-label">Supplier Name</label>
{{--                            <input type="text" class="form-control" id="invoice_supplier" required >--}}
{{--                            <div class="invalid-feedback">--}}
{{--                                Please input drug supplier.--}}
{{--                            </div>--}}
                            <select name="" id="invoice_supplier" class="form-control">
                ...
                <div class="col-12">
                    <button class="btn btn-primary btn-medix" id="save_btn" type="submit" style="visibility:hidden;">Save</button>
